...
pub const PUBKEY_ADDRESS_PREFIX_TEST: u8 = 16; 
...
const GENESIS_BLOCK_HASH_TESTNET: [u8; 32] = [124, 240, 177, 93, 148, 201, 214, 147, 239, 202, 221, 86, 220, 158, 213, 15, 176, 18, 15, 130, 147, 228, 72, 7, 98, 60, 159, 237, 6, 57, 143, 30];
const GENESIS_BLOCK_HASH_SIGNET: [u8; 32] = [124, 240, 177, 93, 148, 201, 214, 147, 239, 202, 221, 86, 220, 158, 213, 15, 176, 18, 15, 130, 147, 228, 72, 7, 98, 60, 159, 237, 6, 57, 143, 30];
const GENESIS_BLOCK_HASH_REGTEST: [u8; 32] = [124, 240, 177, 93, 148, 201, 214, 147, 239, 202, 221, 86, 220, 158, 213, 15, 176, 18, 15, 130, 147, 228, 72, 7, 98, 60, 159, 237, 6, 57, 143, 30];
...
mod test {
    ...
    fn bitcoin_genesis_full_block() {
        ...
        assert_eq!(gen.header.merkle_root.to_hex(), "71af8a6b906ecef9cf9cb05a593639f6bd2db7cefb9b2ceaed9065b97b01fa35");

        assert_eq!(gen.header.time, 1231006505);
        assert_eq!(gen.header.bits, 0x1d00ffff);
        assert_eq!(gen.header.nonce, 2083236893);
        assert_eq!(gen.header.block_hash().to_hex(), "64a9141746cbbe06c7e1a4b7f2abb968ccdeba66cd67c1add1091b29db00578e");
    }
